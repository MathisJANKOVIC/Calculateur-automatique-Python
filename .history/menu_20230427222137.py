...
lab_title.pack(pady=SCREEN_HEIGHT/11)

equations_frame = tkinter.Frame(window)
equations_frame.pack()
equation1 = tkinter.Button(equations_frame, text="ax + b = 0", font=("Arial", 14), fg="black", width=SCREEN_HEIGHT/10)
equation1.pack(pady=10)
equation2 = tkinter.Button(equations_frame, text="ax² + bx + c = 0", font=("Arial", 15), width=SCREEN_HEIGHT/10)
equation2.pack(pady=10)
equation3 = tkinter.Button(equations_frame, text="ax + b = cx + d", font=("Arial", 15), width=SCREEN_HEIGHT/10)
