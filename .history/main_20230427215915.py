...
equation1 = tkinter.Button(equations_frame, text="(1) ax + b = 0", font=("Arial", 14), fg="black")
equation1.pack()
equation2 = tkinter.Button(equations_frame, text="(2) ax² + bx + c = 0", font=("Arial", 15))
equation2.pack()
equation3 = tkinter.Button(equations_frame, text="(3) ax + b = cx + d", font=("Arial", 15))
equation3.pack()
window.mainloop()
