...
lab_title = tkinter.Label(
    window, text="Quel type d'équation vous-voulez résoudre ?", font=("Arial", 17))

# fonction de rappel pour mettre à jour la distance de remplissage


def update_padding(event):
    pady = event.height // 4
    lab_title.pack_configure(pady=pady)


# lier l'événement "Configure" à la fonction de rappel
window.bind("<Configure>", update_padding)

# afficher l'étiquette
lab_title.pack(pady=SCREEN_HEIGHT // 4)
