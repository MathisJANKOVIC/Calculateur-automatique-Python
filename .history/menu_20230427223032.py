...
lab_title.pack(pady=(SCREEN_HEIGHT/9, SCREEN_HEIGHT /12))

equations_frame = tkinter.Frame(window)
equations_frame.pack()
equation1 = tkinter.Button(equations_frame, text="ax + b = 0", font=("Arial", 14), fg="black", width=SCREEN_WIDTH//33)
equation1.pack(pady=SCREEN_WIDTH//55)
equation2 = tkinter.Button(equations_frame, text="ax² + bx + c = 0", font=("Arial", 15), width=SCREEN_WIDTH//33)
equation2.pack(pady=SCREEN_WIDTH/55)
equation3 = tkinter.Button(equations_frame, text="ax + b = cx + d", font=("Arial", 15), width=SCREEN_WIDTH//33)
equation3.pack(pady=SCREEN_WIDTH/55)
window.mainloop()
