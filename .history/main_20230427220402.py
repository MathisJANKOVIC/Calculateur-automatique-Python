...
equation1 = tkinter.Button(equations_frame, text="ax + b = 0", font=("Arial", 14), fg="black")
equation1.pack(pady=10,width=30)
equation2 = tkinter.Button(equations_frame, text="ax² + bx + c = 0", font=("Arial", 15))
equation2.pack(pady=10, width=30)
equation3 = tkinter.Button(equations_frame, text="ax + b = cx + d", font=("Arial", 15))
equation3.pack(pady=10, width=30)
window.mainloop()
