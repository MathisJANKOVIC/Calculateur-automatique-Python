...
lab_title = tkinter.Label(window, text="Quel type d'équation vous-voulez résoudre ?", font=("Arial", 15))
lab_title.pack(pady=15)

equations_frame = tkinter.Frame(window)
equations_frame.pack()
equation1 = tkinter.Label(equations_frame, text="(1) ax + b = 0", font=("Arial", 14), fg="black")
equation1.pack()
equation2 = tkinter.Label(equations_frame, text="(2) ax² + bx + c = 0", font=("Arial", 13))
equation2.pack()
equation3 = tkinter.Label(equations_frame, text="(3) ax + b = cx + d", font=("Arial", 13))
equation3.pack()
window.mainloop()
